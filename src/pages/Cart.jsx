...
function Cart(){
  ...
  return (
    <div>
      ...
      {
        cart.length>0?(
          <div className='w-[880px] mx-auto flex flex-row gap-3 '>
          <div className='w-[60%]'>
            {
              cart.map((post)=>{
          ...
          <div className='w-[40%] border-2 rounded h-[650px] p-3'>
          ...
          <div className='mt-[440px] w-full flex flex-col gap-y-4'>
            ...
            <button className=' w-[75%] bg-green-600 text-white rounded-md font-bold py-2 px-4'>CheckOut Now</button>
          </div>
